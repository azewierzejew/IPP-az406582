 ...
 * @return zwraca ujemną liczbę jeśli pierwszy dystans jest lepszy, dodatnią w odwrotnym wypadku,
 * 0 gdy są takie same.
 */
 ...
 * Nie używa krawędzi o długości  0, również nie przechodzi przez miasta,
 ...
 * @param usedRoads - wskaźnik na wektor zużytych dróg (może być NULL).
 * @return Zwraca strukturę @ref RouteSearchAnswer z następującą wartością @ref RouteSearchAnswer.count:
 * - -1, jeśli nastąpił błąd lub argumenty sa niepoprawne;
 * - 0, jeśli nie ma żadnej drogi;
 * - 1, jeśli jest dokładnie jedna droga, wtedy @ref RouteSearchAnswer.roads zawiera @ref Vector odcinków,
 *   a @ref RouteSearchAnswer.distance zawiera łączny dystans;
 * - 2, jeśli są co najmniej dwie drogi o tym samym dystansie,
